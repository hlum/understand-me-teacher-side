...
export const ClassDetailPage = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-950 via-blue-950 to-gray-900 py-12 px-6">
            <div className="max-w-4xl mx-auto backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl p-8 shadow-[0_0_30px_rgba(0,0,0,0.5)]">
                    ...
                    <button
                        onClick={() =>
                            navigate("/AddNewHomeworkPage", {
                                state: { classID: classDetail.id, teacherID: classDetail?.teacherID },
                            })
                        }
